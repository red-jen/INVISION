            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+212661442247" className="text-gray-300 hover:text-blue-300 transition-colors">
                    +212 661 442 247
                  </a>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:invision.electro@gmail.com" className="text-gray-300 hover:text-blue-300 transition-colors">
